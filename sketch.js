...
function detectCollision(rstone,rmango){
  if(rstone.position.x>=rmango.position.x-mangowidth/2&&rstone.position.x<=rmango.position.x+mangowidth/2&&rstone.position.y>=rmango.position.y-mangoheight/2&&rstone.position.y<=rmango.position.y+mangoheight/2){
    Body.setStatic(rmango.body,false);
  }
}